...
function Navbar(props) {
    ...
    const MenuButton = styled.div([tw`flex`, navbarOpen ? tw`md:block` : tw`md:hidden`]);
                ...
                <UpperBar>
                    <div tw="flex justify-between items-center">
                        <div tw="flex items-center">
                            <Link href="/">
                                <a className="text-xl font-bold text-gray-800 lg:text-2xl hover:text-gray-700">
                                    {SiteName}
                                </a>
                            </Link>
                ...
                />
                    ...
                    <NavItemStyled css={[tw`z-50`, navbarOpen ? tw`block` : tw`hidden`]}>
                        <div tw="flex flex-col mt-1 md:flex-row md:mt-0 md:mx-1">
                            ...
                            {menuItems.map((item) => (
                                <div key={item.id} className="relative inline-block dropdown">
                        ...
                        <div className="flex items-center py-2 -mx-1 md:mx-0">
                            <Link href="/admisi">
                                <a
                                    className="block w-1/2 px-3 py-2 mx-1 text-sm font-medium text-center text-white bg-blue-500 rounded leading-5 hover:bg-blue-600 md:mx-2 md:w-auto"
                                    onClick={() => {
