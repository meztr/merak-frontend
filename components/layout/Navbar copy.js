...
import { faFacebook, faGithub, faTwitter } from "node_modules/@fortawesome/free-brands-svg-icons/index";
...
function Navbar(props) {
  ...
  const NavbarStyle = styled.nav(({ isTransparent }) => [
    isTransparent
    ? tw`top-0 absolute z-50 w-full`
    : tw`relative shadow-lg bg-white shadow-lg`,
                    ...
                    <i
                      className={
                        (props.transparent
                          ? "lg:text-gray-300 text-gray-500"
                          : "text-gray-500") +
                        " far text-lg leading-lg mr-2"
                      }
                    > <FontAwesomeIcon icon={faFileAlt} /> </i>{' '}
                    Docs
                  </a>
              </LiStyle>
            </UlStyle>
              ...
              <li className="flex items-center">
                ...
                >
                  <i
                    ...
                    > <FontAwesomeIcon icon={faTwitter} /> </i>{' '}
