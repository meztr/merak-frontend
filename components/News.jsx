    ...
    return (
        <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
            <div className="mb-10 border-t border-b divide-y">
                <div className="py-8 grid sm:grid-cols-4">
                    <div className="mb-4 sm:mb-0">
                        <div className="text-xs font-semibold tracking-wide uppercase space-y-1">
                            <a
                                href="/"
                    ...
                    <div className="sm:col-span-3 lg:col-span-2">
                        ...
                        <p className="text-gray-700">
                            ...
                            a pilot. Then they show that show to the people who make shows.
                        </p>
                    </div>
                </div>
                <div className="py-8 grid sm:grid-cols-4">
                    ...
                    <div className="sm:col-span-3 lg:col-span-2">
                        ...
                        <p className="text-gray-700">
                            ...
                            going to catch the red dot today going.
                        </p>
                    </div>
                </div>
                <div className="py-8 grid sm:grid-cols-4">
