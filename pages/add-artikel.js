    ...
    return (
        <AddArtikelStyled>
            <Box variant="container">
                ...
                <form>
                    <input type="text" 
                        onChange={e => setArtikelTitle(e.target.value)} value={artikelTitle}
                        placeholder="Artikel title" /><br />
                    <input type="text" 
                        onChange={e => setArtikelDeskripsi(e.target.value)} value={artikelDeskripsi}
                        placeholder="Artikel Deskripsi" /><br />
                    <input type="text" 
                        onChange={e => setArtikelSlug(e.target.value)} value={artikelSlug}
                        placeholder="Artikel slug" /><br />
                    <button type="button"
                        onClick={()=> addArtikel()}
                        >Add Artikel
                    </button>
